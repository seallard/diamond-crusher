...
## Strategy
Maximize the average number of diamonds the collector returns to the base per step in a limited time span. To do that, the collector must step as fast and smart as possible.
