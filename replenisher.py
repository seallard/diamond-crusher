...
def main():
    ...
    go_next_to(reset_button, bot_name, token_str)
    ...
    while True:
        ...
        while average_distance_to_k_diamonds_from_position(base, 5) < threshold and number_of_collected_diamonds("seal") < 5:
            sleep(0.1)

        # The collector might have reset the board by accident
        reset_button = find_reset_button()
        go_to(reset_button, bot_name, token_str)
